...
urlpatterns = [
    ...
    path('inbox/<str:link_id>/archived/', views.archived_messages, name='archived_messages'),
    ...
    path('inbox/<str:link_id>/<uuid:msg_id>/unarchive/', views.unarchive_message, name='unarchive_message'),
    ...
    path('api/check-messages/', views.check_new_messages, name='check_messages'),
]
